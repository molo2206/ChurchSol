...
{
    public partial class FrmPreducateur : Form
    {
        public FrmPreducateur()
        {
            InitializeComponent();
        }
        ...
        private void FrmPreducateur_Load(object sender, EventArgs e)
        {
            fx.Picture_Rond(profile);
            dao.chargementGridOptimise("select * from preducateur", Listebapteme);
            check.Checked = false;
                ...
                switch (btnsuite.Text)
                {
                    case "Enregistrer":
                        ...
                        else
                        {
                            ...
                            string rqt = "exec [AjoutPredicateur]'" + cl.Code_predicateur + "','" + cl.Nom_preducateur + "','" + cl.Mail + "','" + cl.Phone + "','" + cl.Provenance + "','" + cl.Ministere + "','" + cl.Sexe + "'";
                            dao.Executer(rqt);
                            dao.chargementGridOptimise("select * from preducateur", Listebapteme);
                        }
                        break;
        ...
        {
            dao.chargementGridOptimise("select * from Preducateur  where nom_complet like '%"+rech.Text+"%'",Listebapteme);
        }
